...
class WPFooter:
    ...
    @property
    def footer_site_title_element(self):
        """
    ...
    @property
    def footer_site_title_text(self):
        """
        :return: The text of the footer site title element
        """
        return self.footer_site_title_element.text

    @property
    def footer_wordpress_element(self):
        """
    ...
    @property
    def footer_wordpress_element_text(self):
        """
        :return: The text of the footer Wordpress link
        """
        return self.footer_wordpress_element.text

    @property
    def footer_wordpress_social_facebook_element(self):
        """
    ...
    @property
    def footer_wordpress_social_facebook_text(self):
        """
        :return: The text of the footer social Facebook link
        """
        return self.footer_wordpress_social_facebook_element.text

    @property
    def footer_wordpress_social_twitter_element(self):
        """
    ...
    @property
    def footer_wordpress_social_twitter_text(self):
        """
        :return: The text of the footer social Twitter link
        """
        return self.footer_wordpress_social_twitter_element.text

    @property
    def footer_wordpress_social_github_element(self):
        """
    ...
    @property
    def footer_wordpress_social_github_text(self):
        """
        :return: The text of the footer social Github link
        """
        return self.footer_wordpress_social_github_element.text

    @property
    def footer_wordpress_social_linkedin_element(self):
        """
    ...
    @property
    def footer_wordpress_social_linkedin_text(self):
        """
        :return: The text of the footer social LinkedIn link
        """
        return self.footer_wordpress_social_linkedin_element.text
